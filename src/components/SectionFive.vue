<template>
    <section class="section">
        <div class="section__top">
            <h2>Our News</h2>
            <p>Soluta eos eaque numquam. Ipsam perferendis sit, bo quasi ex rem distinctio.</p>
        </div>
        ...
        <div class="section__bottom">
            <button class="btn">GO TO NEWS</button>
        </div>
    </section>
</template>
